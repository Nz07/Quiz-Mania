...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1 class="text-light"><a href="index.php"><span>Quiz-Mania</span></a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#quizz">Quizzes</a></li>
    ...
    <div class="container">
      <div class="row gy-4">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>Test Your Skills with <br>Quiz-Mania</h1>
          <h2> &#9989; Automated scoring and grading<br>
            &#9989; Time restricted questions & time outs <br>
            &#9989; Instant feedback on in/correct answers</h2>
          <div>
         <a href="trail.php"  class="btn-get-started scrollto">Try Quiz !!</a>&emsp;&emsp;
            <a href="register.php" style="border-radius:50px !important;padding: 10px 25px;" class="btn-get-started scrollto">Register</a>
      ...
      <div class="container">
        ...
        <div class="row justify-content-between">
          <div class="col-lg-5 d-flex align-items-center justify-content-center about-img">
            <img src="assets/img/developer_outline I.png" class="img-fluid  " alt="" data-aos="zoom-in">
          </div>
          <div class="col-lg-6 pt-5 pt-lg-0">
            <h3 data-aos="fade-up">Grade Your Tests Automatically</h3>
            <p data-aos="fade-up" data-aos-delay="10">
              Add scores or points to each answer and your quiz will tell your
              students how they did automatically after they complete it.
            </p>
            <div class="row">
              <div class="col-md-6" data-aos="fade-up" data-aos-delay="10">
                <i class="bx bx-receipt"></i>
                <h4>Show Students Instant Feedback</h4>
                <p>Mark answers as correct or incorrect for instant feedback.</p>
              </div>
              <div class="col-md-6" data-aos="fade-up" data-aos-delay="10">
                <i class="bx bx-tachometer"></i>
                <h4>Add Time Limits</h4>
                <p>Make your quizzes more challenging by 15 seconds time-restricting each question.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="qu-col">
        <div class="qu-sec">
          ...
          <div class="panelz" >
            ...
            <a href="login.php">TRY ME !!!! <i class="bi bi-arrow-right"></i></a>
          </div>
        </div>
  ...
  <br>
    ...
    <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="10">
            <div class="icon-box">
              <div class="icon"><i class="bx bxl-dribbble"></i></div>
              <h4 class="title"><a href="">Engage your audience</a></h4>
              <p class="description">Engage your audience in a unique and fun way and connect them to your brand or learning material. By creating a returning event, you will improve your consumer loyalty.</p>
            </div>
          </div>

          <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="11">
            <div class="icon-box">
              <div class="icon"><i class="bx bx-file"></i></div>
              <h4 class="title"><a href="">Randomizing questions</a></h4>
              <p class="description">It is significant more easy to randomize your question with just one click than to do it all manually. Randomizing questions and even answers of those questions is not a lot a of work to do with online quizzes.</p>
            </div>
          </div>

          <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="12">
            <div class="icon-box">
              <div class="icon"><i class="bx bx-cube-alt"></i></div>
              <h4 class="title"><a href="">Large number</a></h4>
              <p class="description">Taking online quizzes makes it possible to have a large number of participants. It doesn’t matter at what kind of location they take the online quiz as long as they are connected to the Internet.</p>
            </div>
          </div>

          <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="13">
            <div class="icon-box">
              <div class="icon"><i class="bx bx-world"></i></div>
              <h4 class="title"><a href="">Better overview</a></h4>
              <p class="description">It's possible to show one question at the time with online quizzes. People are not able to skip a question, because you will get a reminder that you can’t leave the answer blank.</p>
            </div>
          </div>
    ...
    <section id="faq" class="faq section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <ul class="faq-list" data-aos="fade-up" data-aos-delay="10">
          ...
          <li>
            <div data-bs-toggle="collapse" href="#faq2" class="collapsed question">What are some disadvantages of an online quiz? <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
          ...
          <li>
            <div data-bs-toggle="collapse" href="#faq4" class="collapsed question">Can I assign negative points to a question? <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="10">
            <form action="contact.php" method="post" role="form" name="conatct-form" class="php-email-form" onsubmit="myFunction()">
              <div class="row">
